package com.example.201B285_SharedPreferences_ComplexObjects;
...
public class MainActivity extends AppCompatActivity {
    ...
    String []winnersArray={"Tanishi", "Swara", "Tanisha"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=this.getSharedPreferences("com.example.201B285_SharedPreferences_ComplexObjects", Context.MODE_PRIVATE);
